package dofold.render
{
	...
	import dofold.math.Matrix44;
	import dofold.render.renderer.BasicRenderer;
	import dofold.render.renderer.IRenderer;
	import dofold.shader.AGALCode;
	import dofold.shader.AGALMiniAssembler;
	import dofold.space.camera.CameraBasic;
	import dofold.space.camera.lens.LensBasic;
	import dofold.space.primitive.api.IPrimitive;
	import dofold.space.scene.Scene;
	...
	public class Viewport extends Sprite
	{
		...
		public function render():void
		{
			...
			for (i = 0; i < count; i += 1)
			{
				...
				child.model.appendTranslation(-100 + i % 6 * 40, -200 + int(i / 6) * 40, 100.0);
